...
std_msgs::Int32 MVX_ros;
std_msgs::Int32 MVY_ros;
std_msgs::Int32 MVZ_ros;

ros::Publisher encoder("/pulse_encoder" , &pulse_encoder);
ros::Publisher mvy_pub("/MVY" , &MVY_ros);
...
void odomCb(geometry_msgs::Pose2D &msg_odom){
  pos_x = msg_odom.x;
  pos_y = msg_odom.y;
  pos_z = msg_odom.theta;
}
...
ros::Subscriber<geometry_msgs::Pose2D> odom("/pose_Input", odomCb);
